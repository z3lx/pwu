...
enum class VirtualKey : uint8_t {
    ...
    Delete = VK_DELETE,
    Help = VK_HELP,
    D0 = static_cast<uint8_t>('0'),
    D1 = static_cast<uint8_t>('1'),
    D2 = static_cast<uint8_t>('2'),
    D3 = static_cast<uint8_t>('3'),
    D4 = static_cast<uint8_t>('4'),
    D5 = static_cast<uint8_t>('5'),
    D6 = static_cast<uint8_t>('6'),
    D7 = static_cast<uint8_t>('7'),
    D8 = static_cast<uint8_t>('8'),
    D9 = static_cast<uint8_t>('9'),
    A = static_cast<uint8_t>('A'),
    B = static_cast<uint8_t>('B'),
    C = static_cast<uint8_t>('C'),
    D = static_cast<uint8_t>('D'),
    E = static_cast<uint8_t>('E'),
    F = static_cast<uint8_t>('F'),
    G = static_cast<uint8_t>('G'),
    H = static_cast<uint8_t>('H'),
    I = static_cast<uint8_t>('I'),
    J = static_cast<uint8_t>('J'),
    K = static_cast<uint8_t>('K'),
    L = static_cast<uint8_t>('L'),
    M = static_cast<uint8_t>('M'),
    N = static_cast<uint8_t>('N'),
    O = static_cast<uint8_t>('O'),
    P = static_cast<uint8_t>('P'),
    Q = static_cast<uint8_t>('Q'),
